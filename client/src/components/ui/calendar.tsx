  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        month: "space-y-4 w-64", // Fixed width for month container
        ...
        table: "w-full border-collapse space-y-1 table-fixed", // Using table-fixed for fixed width cells
        head_row: "flex",
        head_cell:
          "text-muted-foreground rounded-md w-9 font-normal text-[0.8rem] flex-1", // Added flex-1 for equal spacing
