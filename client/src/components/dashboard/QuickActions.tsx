...
export default function QuickActions() {
  ...
  return (
    <div className="mt-8 space-y-3">
      ...
      >
        <span className="font-medium font-elegant">Add Wine to My Cellar</span>
      ...
      >
        <span className="font-medium font-elegant">Drink or Remove</span>
      ...
      <Link href="/wishlist" className="w-full flex items-center justify-between bg-white border border-burgundy-600 hover:bg-cream-50 text-burgundy-600 p-3 rounded-md transition-colors">
        <span className="font-medium font-elegant">My Wish List</span>
        <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
      ...
      <Link href="/notes" className="w-full flex items-center justify-between bg-white border border-burgundy-600 hover:bg-cream-50 text-burgundy-600 p-3 rounded-md transition-colors">
        <span className="font-medium font-elegant">My Notes</span>
        <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
          <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z" />
        </svg>
      </Link>
      
      <Link href="/remove-by-label" className="w-full flex items-center justify-between bg-white border border-burgundy-600 hover:bg-cream-50 text-burgundy-600 p-3 rounded-md transition-colors">
        <span className="font-medium font-elegant">Remove by Label</span>
        <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
      ...
      <Dialog open={showAddWineModal} onOpenChange={setShowAddWineModal}>
        <DialogContent className="max-w-3xl max-h-[90vh] overflow-y-auto">
          <DialogHeader>
            <DialogTitle className="font-serif">Add Wine to My Cellar</DialogTitle>
          </DialogHeader>
