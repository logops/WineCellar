...
export default function Footer() {
  return (
    <footer className="bg-burgundy-800 text-cream-100 py-6">
      <div className="container mx-auto px-4">
        <div className="flex flex-col md:flex-row justify-between">
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 gap-8">
            <div>
              <h3 className="font-montserrat font-semibold mb-3 text-white">Features</h3>
              <ul className="space-y-2 text-sm text-cream-300">
                <li><Link href="/collection" className="hover:text-white transition-colors">Wine Collection</Link></li>
                <li><Link href="/collection" className="hover:text-white transition-colors">Drinking Windows</Link></li>
                <li><Link href="/collection" className="hover:text-white transition-colors">Value Tracking</Link></li>
                <li><Link href="/reports" className="hover:text-white transition-colors">Reports & Analytics</Link></li>
              </ul>
            </div>
            
            <div>
              <h3 className="font-montserrat font-semibold mb-3 text-white">Account</h3>
              <ul className="space-y-2 text-sm text-cream-300">
            ...
            <div>
              <h3 className="font-montserrat font-semibold mb-3 text-white">Support</h3>
              <ul className="space-y-2 text-sm text-cream-300">
